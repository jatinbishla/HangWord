"""Hangword
Standard game of Hangword. A word is chosen at random from a list and the
user must guess the word letter by letter before running out of attempts."""

import random
a=input("Hello Mate,  What's you name? ")
print("Well, that's perfect moment to play some Hangword!\n")
while True:
...
def main():
    welcome = ['Welcome to Hangword! A word will be chosen at random and',
    ...
    while play_again:
        ...
        words = ["hangman", "chairs", "backpack", "bodywash", "clothing",
                 ...
                 "algebra", "suitcase", "knives", "ninjas", "shampoo","lion",
                 "umbrella", "window", "computer", "glass", "juice", "chair", "desktop",
                 "laptop", "dog", "cat", "lemon", "cabel", "mirror", "hat", "duster", "protien",
                 "classmate", "marker", "memories", "rough", "badge", "digital", "curtains",
                 "engineer", "software", "family", "calender", "exercise", "technology"
                 ]
...
""")
        ...
        while (attempts != 0 and "-" in word_guessed):
            ...
            if player_guess not in chosen_word:
                attempts -= 1
                print(HANGWORD[(len(HANGWORD) - 1) - attempts])
